...
function nextQuestion() {
    ...
    const num1 = Math.floor(Math.random() * 26); // Numbers from 0 to 25
    const num2 = Math.floor(Math.random() * 26); // Numbers from 0 to 25
    ...
    while (options.length < 4) {
        const randomAnswer = Math.floor(Math.random() * 30) - 4; // Answers between -4 and 25
